          ...
          <div className="grid gap-4 md:gap-8">
            <div>
              <p className="mb-8 text-xl text-black-3">
                This Terms & Conditions outlines our practices regarding the
              ...
              <p className="mb-5 text-black-3">
                For questions about this Terms & Conditions or our privacy
              ...
              <p className="mb-5 text-black-3">
                If we change our Terms & Conditions, we will post those changes
                on this page. Registered users will be sent an email that
                outlines changes made to the Terms & Conditions.
              </p>
            </div>
          </div>
        </div>
